...
public class CoSongActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        ...
        switch ( view.getId()) {
            ...
            case R.id.co1_id : i = new Intent(this, VastActivity.class); startActivity(i) ; break;
            case R.id.co2_id : i = new Intent(this, VastActivity.class); startActivity(i) ; break;
            case R.id.co3_id : i = new Intent(this, VastActivity.class); startActivity(i) ; break;
            case R.id.co4_id : i = new Intent(this, VastActivity.class); startActivity(i) ; break;
            default: break;
        }
    }
}
