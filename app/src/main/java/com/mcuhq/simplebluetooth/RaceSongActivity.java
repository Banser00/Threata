...
public class RaceSongActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch ( view.getId()) {
            ...
            case R.id.ra1_id : i = new Intent(this, VastActivity.class); startActivity(i) ; break;
            case R.id.ra2_id : i = new Intent(this, VastActivity.class); startActivity(i) ; break;
            case R.id.ra3_id : i = new Intent(this, VastActivity.class); startActivity(i) ; break;
            case R.id.ra4_id : i = new Intent(this, VastActivity.class); startActivity(i) ; break;
            default: break;
        }
